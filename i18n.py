...
TRANSLATIONS = {
    ...
    "en": {
        ...
        "desc_for_you": "Products selected just for you based on your history",
        "desc_cart_items": "You have items waiting! Ready to checkout?",
        "desc_empty_cart": "Your cart is currently empty",
        "desc_find_size": "Find your perfect fit instantly",
        "desc_view_orders": "View your recent purchases and status",
        "desc_cancel_order": "Request a cancellation for a recent order",
        "desc_talk_human": "Pause the AI and chat with a real human",
        "desc_change_lang": "English / বাংলা",
        "desc_clear_cart": "Empty all items from your cart",
    ...
    "bn": {
        ...
        "section_store": "🛍️ স্টোর",
        "section_account": "👤 অ্যাকাউন্ট",
        "section_support": "📞 সাপোর্ট",
        "section_special_offers": "🔥 স্পেশাল অফার",
        "section_mens_collection": "🛍️ মেন্স কালেকশন",
    ...
    "blish": {
        ...
        "btn_no_keep": "Na, Order ti rakhtte chaile click korun",
