...
class RAGAgent:
    ...
    async def answer_query(self, query: str, history: list = None, orders: list = None) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "- Processing returns or exchanges is out of scope for this AI chatbot.\n"
            "- If the user asks about returns or exchanges, tell them politely that return/exchange requests must be handled by our support staff, and that they can click 'Talk to Staff' or message/call 09617-700500.\n\n"
