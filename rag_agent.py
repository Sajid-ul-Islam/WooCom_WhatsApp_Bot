...
class RAGAgent:
    ...
    async def answer_query(self, query: str, history: list = None, orders: list = None) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "Delivery Policy:\n"
            "- Inside Dhaka: 50 BDT, 1-2 days\n"
            "- Outside Dhaka: 90 BDT, 2-5 days\n"
            "- Cash on Delivery (COD) is available nationwide.\n\n"
            "Return & Exchange Policy:\n"
            "- 3 days hassle-free exchange for size issues (must apply within 24 hours of receiving).\n"
            "- Exchange delivery fee: 50 Tk (Inside Dhaka) / 90 Tk (Outside Dhaka).\n"
            "- No returns/exchanges for undergarments, boxers, or masks.\n"
            "- Returns/Exchanges must be in original, unused condition with tags.\n\n"
            "Contact, Tracking & Outlets:\n"
            "- Phone: 09617-700500 (10 AM - 6 PM, Sat-Thu)\n"
            "- Track Order: https://deencommerce.com/track-order/\n"
            "- Outlets: Mirpur 12 (Dhaka), Wari (Dhaka), Cumilla, Sylhet. (https://deencommerce.com/outlet/)\n\n"
            "Guidelines:\n"
